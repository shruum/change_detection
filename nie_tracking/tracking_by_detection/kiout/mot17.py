    ...
    for idx, seq in enumerate(seqs):
        if seq == "name" or seq == "":
            ...
            if "DPM" in seq:
                ...
                print(
                    "No detector name found, this could happen with the wrong seqmap seqmap file. "
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="IOU Tracker MOT17 demo script. The best parameters for each detector "
        "are hardcoded."
    )
    parser.add_argument(
        "-m",
