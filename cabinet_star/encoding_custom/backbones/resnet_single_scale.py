...
from encoding_custom.utils.swiftnet_utils import (
    _Upsample,
...
__all__ = [
    "ResNet",
    "resnet18_single_scale",
    "resnet18dws",
    "resnet34_single_scale",
    "resnet50_single_scale",
    "resnet101_single_scale",
    "resnet152_single_scale",
    "BasicBlock",
]
...
def resnet18_single_scale(pretrained=True, **kwargs):
    ...
    if pretrained:
        try:
            model.load_state_dict(
                torch.load(model_urls["resnet18dws"])["state_dict"], strict=True
            )
...
def resnet34_single_scale(pretrained=True, **kwargs):
...
def resnet50_single_scale(pretrained=True, **kwargs):
...
def resnet101_single_scale(pretrained=True, **kwargs):
...
def resnet152_single_scale(pretrained=True, **kwargs):
