...
def do_train(
    ...
    with EnergyMeter(
        writer=summary_writer, dir=checkpointer.save_dir
    ) if args.calc_energy else ExitStack():
        for iteration, (images, targets, _) in enumerate(data_loader, start_iter):
            ...
            if cfg.MODEL.HEAD.NAME == "CenterNetHead":
                loss = loss_dict["loss"]
            ...
            if iteration % args.log_step == 0:
                ...
                logger.info(
                    meters.delimiter.join(
                        ...
                        iter=iteration,
                        epo=iteration
                        // (len(data_loader.dataset) // cfg.SOLVER.BATCH_SIZE),
