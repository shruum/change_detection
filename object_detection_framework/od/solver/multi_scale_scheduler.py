...
class WarmupMultiScaleLR(_LRScheduler):
    ...
    def __init__(
        self, optimizer, lr_steps, lr_scales, weight_decay, batch_size, last_epoch=-1
    ):
    ...
    def get_lr(self):
        ...
        for i in range(len(self.lr_steps)):
            ...
            if self.last_epoch >= self.lr_steps[i]:
                ...
                break
        return [base_lr / self.batch_size for base_lr in scaled_lrs]
