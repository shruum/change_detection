...
def main():
    ...
    parser.add_argument(
        "--ckpt",
        type=str,
        default=const.DEFAULT_CKPT,
        help="Trained weights (default: %(default)s).",
    )
    parser.add_argument(
        "--score_threshold",
        type=restricted_float,
        default=const.DEFAULT_SCORE_THRESHOLD,
        help="Threshold value (default: %(default)s).",
    )
    parser.add_argument(
        "--dataset_type",
        type=str,
        choices=["coco", "voc", "had", "ark"],
    ...
    parser.add_argument(
        "--input",
        type=str,
        default=const.DEFAULT_INPUT_DIR,
    ...
    parser.add_argument(
        "--output_format",
        type=str,
        choices=["img", "json", "json_nie", "txt", "xml"],
