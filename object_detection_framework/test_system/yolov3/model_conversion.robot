*** Settings ***
Documentation    Facility to test model conversion and inference of YoloV3.
...
*** Variables ***
${TEST_DATA}    /data/nie/teams/arl/system_tests_data/object_detection_framework/yolov3
${BIN_DIR}    ${HOME_DIR}/build/bin
${OUT_DIR}    ${HOME_DIR}
${MODEL}    yolov3
${CONFIG_FILE}    configs/yolov3/darknet53_yolov3_voc0712.yaml
${TEST_OUT}    ${CURDIR}/tdo
...
Convert PyTorch model into ONNX using modeltoonnx to yolov3
    [Tags]    onnx_converter
    ...
    Generated onnx model should be valid    ${MODEL}.onnx    backbone_nr=312    header_line_nr=126    nms_nr=1
...
Inference with onnx engine and trtexec_json
    ...
    ...    executor=${BIN_DIR}/trtexec_json    model=${MODEL}    threshold=0.4    test_out=${TEST_OUT}    test_data=${TEST_IN}
    Log    ${log}
    Should Be Equal As Integers    ${rc}    0
    ${expected_list}=    Create List    14
...
Inference with PyTorch
    ...
    ...    \ --ckpt ${MODEL_FILE}
    ...    \ --eval_only
    ...    \ OUTPUT_DIR ../../outputs LOGGER.DEBUG_MODE True TEST.CONFIDENCE_THRESHOLD 0.05
    ${rc}    ${log}    Run And Return Rc And Output    ${cmd}
    Log    ${log}
